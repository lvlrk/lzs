...
# Project:  lzs.pro
# Template: app
# Command: /usr/bin/qmake -o Makefile lzs.pro
#############################################################################
...
COMPRESS      = gzip -9f
DISTNAME      = lzs1.0.0
DISTDIR = /media/sdb1/Code/lzs/build/lzs1.0.0
LINK          = g++
...
Makefile: lzs.pro /usr/lib/qt/mkspecs/linux-g++/qmake.conf /usr/lib/qt/mkspecs/features/spec_pre.prf \
		/usr/lib/qt/mkspecs/common/unix.conf \
		/usr/lib/qt/mkspecs/common/linux.conf \
		/usr/lib/qt/mkspecs/common/sanitize.conf \
		/usr/lib/qt/mkspecs/common/gcc-base.conf \
